...
class DetailedPlanetStage(Stage):
    """Placeholder implementation for the Detailed planet stage."""

    name = "detailed_planet"
    input_schema = "stages/detailed_planet/planet_input.schema.json"
    output_schema = "stages/detailed_planet/planet_output.schema.json"

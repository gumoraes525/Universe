...
class PlanetaryBodiesStage(Stage):
    """Placeholder implementation for the Planetary bodies stage."""

    name = "planetary_bodies"
    input_schema = "stages/planetary_bodies/bodies_input.schema.json"
    output_schema = "stages/planetary_bodies/bodies_output.schema.json"

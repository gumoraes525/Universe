...
class StellarSystemStage(Stage):
    """Placeholder implementation for the Stellar system stage."""

    name = "stellar_system"
    input_schema = "stages/stellar_system/system_input.schema.json"
    output_schema = "stages/stellar_system/system_output.schema.json"
